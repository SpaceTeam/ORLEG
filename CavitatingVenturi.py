...
if __name__ == "__main__":
	...
	venturi = CavitatingVenturi(fluid='ethanol', temperature=273+25, throat_diameter=1.0e-3, discharge_coefficient=0.87)

	pressure_bar = 30
	massFlow = venturi.getMassFlow(pressure_bar * 1e5)

	print("mass flow with", venturi.throat_diameter * 1e3, "mm diameter venturi at", pressure_bar, "bar upstream pressure:", round(massFlow, 3), "kg/s")